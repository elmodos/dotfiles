...
--
-- Leader -> "s" enters a dedicated scroll sub-mode that synthesizes real
...
return function(leader)
    ...
    local function showHint()
        ...
        alertId = hs.alert.show(HINT_TEXT, leader.alertStyle, hs.screen.mainScreen(), HINT_DURATION)
    end
    ...
    leader.registerCommand({}, "s", function() scroll:enter() end, "s — scroll")
end
